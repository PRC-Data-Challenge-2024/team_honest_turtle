...
challenge_file = r"F:\Project_PRC_Eurocontrol\NEW\Input_data\BASE_DATA\7\Updated_challenge_set_final.csv"
...
def process_challenge_file(file_path):
    try:
...
def main():
    process_challenge_file(challenge_file)
